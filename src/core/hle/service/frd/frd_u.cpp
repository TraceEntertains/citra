...
FRD_U::FRD_U(std::shared_ptr<Module> frd) : Module::Interface(std::move(frd), "frd:u", 8) {
    static const FunctionInfo functions[] = {
        {0x00010000, &FRD_U::HasLoggedIn, "HasLoggedIn"},
        {0x00020000, nullptr, "IsOnline"},
        {0x00030002, &FRD_U::Login, "Login"},
        {0x00040000, &FRD_U::Logout, "Logout"},
        {0x00050000, &FRD_U::GetMyFriendKey, "GetMyFriendKey"},
        {0x00060000, &FRD_U::GetMyPreference, "GetMyPreference"},
        {0x00070000, &FRD_U::GetMyProfile, "GetMyProfile"},
        {0x00080000, &FRD_U::GetMyPresence, "GetMyPresence"},
        {0x00090000, &FRD_U::GetMyScreenName, "GetMyScreenName"},
        {0x000A0000, &FRD_U::GetMyMii, "GetMyMii"},
        {0x000B0000, nullptr, "GetMyLocalAccountId"},
        {0x000C0000, nullptr, "GetMyPlayingGame"},
        {0x000D0000, &FRD_U::GetMyFavoriteGame, "GetMyFavoriteGame"},
        {0x000E0000, nullptr, "GetMyNcPrincipalId"},
        {0x000F0000, &FRD_U::GetMyComment, "GetMyComment"},
        {0x00100040, &FRD_U::GetMyPassword, "GetMyPassword"},
        {0x00110080, &FRD_U::GetFriendKeyList, "GetFriendKeyList"},
        //{0x00120042, &FRD_U::GetFriendPresence, "GetFriendPresence"},
        {0x00130142, nullptr, "GetFriendScreenName"},
        {0x00140044, &FRD_U::GetFriendMii, "GetFriendMii"},
        ...
        {0x00200002, &FRD_U::AttachToEventNotification, "AttachToEventNotification"},
        {0x00210040, &FRD_U::SetNotificationMask, "SetNotificationMask"},
        {0x00220040, nullptr, "GetEventNotification"},
        {0x00230000, &FRD_U::GetLastResponseResult, "GetLastResponseResult"},
        ...
        {0x00280244, &FRD_U::RequestGameAuthentication, "RequestGameAuthentication"},
        {0x00290000, &FRD_U::GetGameAuthenticationData, "GetGameAuthenticationData"},
